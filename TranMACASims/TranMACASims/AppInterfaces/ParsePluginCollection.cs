...
namespace GISTranSim
{
    ...
    class ParsePluginCollection
    {
        ...
        private IDictionary<string, GISTranSim.ICommand> _ICmdContainer;

        internal IDictionary<string, GISTranSim.ICommand> getICmdContainer
        {
            get { return _ICmdContainer; }
        }
        private IDictionary<string, GISTranSim.ITool> _IToolContainer;

        internal IDictionary<string, GISTranSim.ITool> getIToolContainer
        {
            get { return _IToolContainer; }
        }
        private IDictionary<string, GISTranSim.IToolBarDef> _IToolBarDefContainer;

        internal IDictionary<string, GISTranSim.IToolBarDef> getIToolBarDefContainer
        {
            get { return _IToolBarDefContainer; }
        }
        private IDictionary<string, GISTranSim.IMenuDef> _IMenuDefContainer;

        internal IDictionary<string, GISTranSim.IMenuDef> getIMenuDefContainer
        {
            get { return _IMenuDefContainer; }
        }
        private IDictionary<string, GISTranSim.IDockableWndDef> _IDockableWndContainer;

        internal IDictionary<string, GISTranSim.IDockableWndDef> getIDockableWndContainer
        {
