...
//
        ...
        public static bool operator == (OxyzPointF a, OxyzPointF b)
        {
		...
		public OxyzPointF(Point p):this(p.X,p.Y,0F){}
		
		public static OxyzPointF Default
		{	
			get{return new OxyzPointF(0f,0f,0.000001f);}
		}
//
		//-----------------------------20160130-----------------------------
		/// <summary>
...
//				hashCode += 1000000021 * _Z.GetHashCode();
				...
				hashCode +=(int)(1000 * _X*_X );
				hashCode +=(int)( 10 * _Y * _Y);
				hashCode +=(int)( 1 * _Z);
			}
			return hashCode;
		}
