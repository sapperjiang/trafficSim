...
namespace SubSys_MathUtility
{
	...
	public static class Coordinates
	{
		...
		/// 向下平移Y为正
		/// </summary>
		public static OxyzPointF GraphicsOffset = new OxyzPointF(0, 0);
		///// <summary>
...
//		}
		...
		{
            Coordinates.Offset(ref old, 1, panVector);
		}
        ...
        /// <param name="old"></param>
        /// <param name="panVector">平移向量</param>
        public static void Offset(ref Point old,int iScaler, Point panVector)
        {
            old.Y += iScaler*panVector.Y;
            old.X += iScaler*panVector.X;
        }
        //public static List<Point> OffsetShape(List<Point> old, int step,OxyzPoint normVector)
        //{
