...
//		}
		...
		private double _fWidth=1f;
        private int _iLength=1;
		private double _fLength=1;
...
//		
        ...
        /// 用元胞个数计算的实体的宽度，实际宽度等于iWidth*元胞代表的距离
        /// </summary>
        public virtual double TrueWidth
        {
            get { return _fWidth; }
            set { _fWidth = value; }
        }
        ...
        /// </summary>
        public virtual double TrueLength
		{
			get { return _fLength; }
			set { _fLength = value; }
		}
		...
		/// 除以元胞的GUI长度
		/// 对于RoadLane和Way以及Cell，该坐标X为相对于起点RoadNode的元胞个数
		...
		public virtual IEntity Container
		{
			get
			{
				...
				//}
				//throw new System.Exception("An entity must have a container");
			}
			set
			{
        ...
        [System.Obsolete("should be abstract ")]
		...
		/// <summary>
		///Way是item ，Agent是visitor 相当于item.accept(visitor)
		/// </summary>
		/// <param name="ur"></param>
