...
//			Assert.AreEqual(2, es.GetIndex(last),"RIGHT");
			...
			//IStaticFactory iFactory=new StaticFactory();
			
			
			
			//int iRoadWidth = 6;
			//int iBase = 2;
			//var rnA= iFactory.Build(new OxyzPointF(8,20,0),OxyzPointF.Default,EntityType.XNode) as XNode;
			//var rnB = iFactory.Build(new OxyzPointF(28, 20,0),OxyzPointF.Default,EntityType.XNode) as XNode;
