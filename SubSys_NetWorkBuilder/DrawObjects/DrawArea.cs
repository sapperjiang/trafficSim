...
{
    public partial class DrawArea : UserControl, GraphicsDirtyObserver
    {
        #region Constructor
        ...
        private Mementos graphics;    // list of draw objects
        ...
        /// <summary>
        /// List of graphics objects.绘图的缓存器，也是绘图的备忘录。
        /// 点击保存按钮后，才利用graphics缓存生成路网，否则不生成路网。
        /// </summary>
        public Mementos Graphics
        {
            get
            {
                return graphics;
        ...
        public void Initialize(Form owner, DocManager docManager)
        {
            ...
            Graphics = new Mementos();

            // Create undo manager
            undoManager = new CommandManager(Graphics);
        ...
        public void IsDirty(Mementos gList)
        {
            AdjustRendering();
        }
        ...
        {
            if (e.Button == MouseButtons.Left||tools!=null)
