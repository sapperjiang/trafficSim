...
namespace SubSys_NetworkBuilder
{
    ...
    {
        void IsDirty(DrawMementos gList);
    }
    ...
    /// </summary>
    [Serializable]
    public class DrawMementos : ISerializable,IEnumerable<DrawObject>
    {
        #region Members
        ...
        protected DrawMementos(SerializationInfo info, StreamingContext context)
        {
            this.draws = new DrawList();
            this.observers = new List<GraphicsDirtyObserver>();
        ...
        public void AddRange(DrawMementos obj)
        {
            // insert to the top of z-order
            draws.AddRange(obj);
            this.Dirty = true;
